...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (]b4_yyerror_args[YY_("kesalahan sintaks: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
                ...
                YYSIZE_T *yyes_capacity, ]])[yytype_int16 *yyssp, int yytoken)
{
  ...
  /* There are many possibilities here to consider:
     ...
     - The only way there can be no lookahead present (in yychar) is if
       ...
       case, just report a simple "kesalahan sintaks".
...
# define YYCASE_(N, S)                      \
      case N:                               \
        yyformat = S;                       \
      break
      YYCASE_(0, YY_("kesalahan sintaks"));
      YYCASE_(1, YY_("kesalahan sintaks, ditemukan %s"));
      YYCASE_(2, YY_("kesalahan sintaks, ditemukan %s, seharusnya %s"));
      YYCASE_(3, YY_("kesalahan sintaks, ditemukan %s, seharusnya %s atau %s"));
      YYCASE_(4, YY_("kesalahan sintaks, ditemukan %s, seharusnya %s atau %s atau %s"));
      YYCASE_(5, YY_("kesalahan sintaks, ditemukan %s, seharusnya %s atau %s atau %s atau %s"));
# undef YYCASE_
    }
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (]b4_yyerror_args[YY_("kesalahan sintaks"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \]b4_lac_if([[
                                        yyesa, &yyes, &yyes_capacity, \]])[
                                        yyssp, yytoken)
      {
        char const *yymsgp = YY_("kesalahan sintaks");
