...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_MODULO", T_MODULO, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("T_PANGKAT", T_PANGKAT, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_BARU", T_BARU, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_DALAM", T_DALAM, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_PANGKAT: return "T_PANGKAT";
		case T_CLONE: return "T_CLONE";
		case T_NEW: return "T_NEW";
		case T_BARU: return "T_BARU";
